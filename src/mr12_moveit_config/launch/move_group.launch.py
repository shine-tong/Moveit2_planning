...
def generate_move_group_launch_new(moveit_config):
    ...
    octomap_config = {'octomap_frame': 'base_link', 'octomap_resolution': 0.004}
...
def generate_launch_description():
    ...
    return generate_move_group_launch_new(moveit_config)
